...
interface BinancePunksMarketInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "getPunk", values?: undefined): string;
...
export class BinancePunksMarket extends BaseContract {
  ...
  interface: BinancePunksMarketInterface;
  ...
  callStatic: {
    ...
    getPunk(overrides?: CallOverrides): Promise<void>;
